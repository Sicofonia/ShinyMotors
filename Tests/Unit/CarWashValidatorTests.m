classdef CarWashValidatorTests < matlab.unittest.TestCase  
    ...
    methods(Test)       
        function FailsValidationWhenWaterPumpFails(testCase)
            wv = CarWashValidatorFactory.create(WashTypes.Quick);
